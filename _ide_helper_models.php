 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Balance whereDiscount($value)
 ...
 * @property int $products_sold
 * @property numeric $average_order_value
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport query()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport whereAverageOrderValue($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport whereMonth($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport whereOrdersCount($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport whereProductsSold($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport whereTotalSales($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MonthlySalesReport whereYear($value)
 */
	class MonthlySalesReport extends \Eloquent {}
}
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|OrderProduct wherePriceAtPurchase($value)
